...
- [ ] **Step 1: Extend the existing audit masking payload**
...
- [ ] **Step 2: Add nested non-sensitive container coverage**

Add `metadata => ['sessionToken' => '...']` and keep `safe_note => 'visible'`.

- [ ] **Step 3: Assert every raw secret is absent**
...
- [ ] **Step 4: Use canonical keys for mobile/email checks**
...
- [ ] **Step 1: Run Pint on the service and test**

- [ ] **Step 2: Run the complete `QingyuIpAgentModuleTest`**
...
- [ ] **Step 4: Review masking coverage and staged diff**
