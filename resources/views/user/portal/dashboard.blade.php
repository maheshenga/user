...
@section('content')
    ...
    <section class="panel">
        <div data-user-session='@json($currentUser)'>
            ...
            <span>{{ $currentUser['nickname'] ?? $currentUser['email'] ?? $currentUser['mobile'] ?? 'Not logged in' }}</span>
        </div>
