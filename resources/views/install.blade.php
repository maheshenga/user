    ...
    <form class="layui-form layui-form-pane" action="">
        ...
        <div class="bg">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input class="layui-input layui-disabled" name="db_type" autocomplete="off" placeholder="请输入数据库类型" value="{{$envInfo['DB_TYPE']}}" readonly>
                </div>
            </div>
            <div class="layui-form-item">
        ...
        <div class="bg">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input class="layui-input layui-disabled" id="admin_url" name="admin_url" autocomplete="off" lay-verify="required" lay-reqtext="请输入后台的地址" placeholder="为了后台安全，不建议将后台路径设置为admin" value="admin" readonly>
